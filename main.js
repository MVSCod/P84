...
keyPressed = e.keyCode;
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90))
        {
            ...
            otherkey();
            document.getElementById("d1").innerHTML="Você pressionou uma tecla Símbolo";
    ...
    {
       img_image="alfabeto_png"
       add();
    }
    function numberkey()
    {
        img_image="número_png"
        add();
    }
    function arrowkey()
    {
        img_image="direcional_png"
        add();
    }
    function specialkey()
    {
        img_image="especial_png"
        add();
    }
    function otherkey()
    {
